...
export const buildAppointmentExpiryPayload = (a: { fullName: string; positionName: string; endDate: Date|string; profileId: string|number }) => ({
...
export const buildContractExpiryPayload = (c: { fullName: string; contractNumber: string; endDate: Date|string; profileId: string|number }) => ({
