export const PERM = {
    ...
    NOTIFICATION: {
        READ:   'hrm.notification.read',
        SEND:   'hrm.notification.send',
        MANAGE: 'hrm.notification.manage',
    },
    ORG: {
        READ:  'hrm.org.read',
        WRITE: 'hrm.org.write',
    ...
    ATTACHMENT: {
        UPLOAD:   'hrm.attachment.upload',
        DOWNLOAD: 'hrm.attachment.download',
        DELETE:   'hrm.attachment.delete',
        VERIFY:   'hrm.attachment.verify',
    },
    WORKFLOW: {
        READ:    'hrm.workflow.read',
        ADVANCE: 'hrm.workflow.advance',
        CANCEL:  'hrm.workflow.cancel',
    },
    SYSTEM: {
